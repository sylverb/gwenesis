...
/* NTSC: 262*3420/1008 = 888.
 * PAL: 313*3420/1008 = 1061. */
#define GWENESIS_AUDIO_BUFFER_LENGTH_NTSC (LINES_PER_FRAME_NTSC * VDP_CYCLES_PER_LINE / AUDIO_FREQ_DIVISOR)
#define GWENESIS_AUDIO_BUFFER_LENGTH_PAL  (LINES_PER_FRAME_PAL  * VDP_CYCLES_PER_LINE / AUDIO_FREQ_DIVISOR)

#define GWENESIS_AUDIO_FREQ_NTSC 53267
#define GWENESIS_AUDIO_FREQ_PAL  53050 // = (GWENESIS_AUDIO_BUFFER_LENGTH_PAL * GWENESIS_REFRESH_RATE_PAL)
